...
class Agent_TD3(object):
    def __init__(self, alpha, beta, input_dims, tau, gamma=0.99,
                 n_actions=12, max_size=1000000, layer1_size=512,
                 layer2_size=512, layer3_size=512, layer4_size=512, batch_size=64,
        ...
        self.actor = ActorNetwork(alpha, input_dims, self.layer1_size,
                                  self.layer2_size, self.layer3_size, self.layer4_size, n_actions=n_actions,
                                  name='Actor')
        ...
        self.target_actor = ActorNetwork(alpha, input_dims, self.layer1_size,
                                      self.layer2_size, self.layer3_size, self.layer4_size, n_actions=n_actions,
                                         name='TargetActor')
