...
'''
    ...
    np.save('Test/Sum_V2I_rate_NO_RIS1000.npy', Sum_rate_list)
    np.save('Test/Sum_V2I_AoI_NO_RIS1000.npy', Sum_AoI_list)
    np.save('Test/Reward_NO_RIS1000.npy', record_reward_average)
