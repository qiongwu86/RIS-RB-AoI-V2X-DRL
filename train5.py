...
if IS_TRAIN:
    ...
    #记录数据，绘制奖励函数曲线
    np.save('Test/Sum_V2I_rate_SAC1000.npy', Sum_rate_list)
    np.save('Test/Sum_V2I_AoISAC1000.npy', Sum_AoI_list)
    np.save('Test/Reward_SAC1000.npy', record_reward_average)
